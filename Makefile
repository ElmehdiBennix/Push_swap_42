...
FILES  :=  parsing/get_node			parsing/valid_args			utils/tools/above_five		utils/tools/under_five			\
		   ...
		   utils/lib/ft_strlen		utils/lib/ft_isdigit		utils/lib/ft_strchr			utils/tools/position_checker	\
		   utils/tools/error		utils/tools/init			utils/tools/get_index     									\
